...
load("results/thetas_pem_u1u3_armax.mat");
load("results/H23s_eq_pem_u1u3_armax.mat");

pyData = py.numpy.load("results/theta_opt_u1u3_arx_init_TR.npy");  
thetas_mle_u1u3 = double(pyData);
pyData = py.numpy.load("results/times_u1u3_arx_init_TR.npy");   
times_mle_u1u3 = double(pyData);

pyData = py.numpy.load("results/theta_opt_u3_arx_init_TR.npy");  
thetas_mle_u3 = double(pyData);
pyData = py.numpy.load("results/times_u3_arx_init_TR.npy");  
