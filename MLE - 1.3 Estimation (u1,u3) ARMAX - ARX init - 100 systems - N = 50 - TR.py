...
for i in range(100):
    ...
    jnp.save("results/theta_opt_u1u3_arx_init_TR_N_50",jnp.array(theta_100))
    jnp.save("results/theta_opt_u1u3_same_arx_init_TR_N_50",jnp.array(theta_100_same))
    jnp.save("results/costs_opt_u1u3_arx_init_TR_N_50",jnp.array(costs_100))
    jnp.save("results/accuracy_u1u3_arx_init_TR_N_50",jnp.array(accuracy_100))
    jnp.save("results/times_u1u3_arx_init_TR_N_50",jnp.array(times_100))
