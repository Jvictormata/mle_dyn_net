...
for i in range(100):
    ...
    jnp.save("results/theta_opt_u3_arx_init_TR",jnp.array(theta_100))
    jnp.save("results/theta_opt_u3_same_arx_init_TR",jnp.array(theta_100_same))
    jnp.save("results/costs_opt_u3_arx_init_TR",jnp.array(costs_100))
    jnp.save("results/accuracy_u3_arx_init_TR",jnp.array(accuracy_100))
    jnp.save("results/times_u3_arx_init_TR",jnp.array(times_100))
