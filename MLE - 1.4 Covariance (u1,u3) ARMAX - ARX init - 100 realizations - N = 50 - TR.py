...
# ----------------------------------------------------------------------
    ...
    np.save("results/cov/theta_opt_u1u3_100_rel_arx_init_TR_N_50",np.array(theta))
    np.save("results/cov/costs_opt_u1u3_100_rel_arx_init_TR_N_50",np.array(cost))
    np.save("results/cov/accuracy_u1u3_100_rel_arx_init_TR_N_50",np.array(accuracy))
