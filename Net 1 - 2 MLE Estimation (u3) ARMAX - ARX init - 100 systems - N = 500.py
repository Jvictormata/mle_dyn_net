...
## Initial value for the c parameters
...
# ----------------------------------------------------------------------
#  Initialization of a and b - MLE of ARX model
# ----------------------------------------------------------------------

    result = minimize(fun=f_MLE_init, x0=theta_init, method='trust-constr', jac=g_MLE_init, hess=H_MLE_init, options={'verbose': 2,'maxiter':1000})
...
# ----------------------------------------------------------------------
    ...
    jnp.save("results/theta_opt_u3_arx_init",jnp.array(theta_100))
    jnp.save("results/theta_opt_u3_same_arx_init",jnp.array(theta_100_same))
    jnp.save("results/costs_opt_u3_arx_init",jnp.array(costs_100))
    jnp.save("results/accuracy_u3_arx_init",jnp.array(accuracy_100))
    jnp.save("results/times_u3_arx_init",jnp.array(times_100))
