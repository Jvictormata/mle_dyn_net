...
u1 = x(3*N_orig+1:3*N_orig+N);
u2 = x(4*N_orig+1:4*N_orig+N);
u3 = x(5*N_orig+1:5*N_orig+N);
r1 = double(r(1:N,1));
r2 = double(r(1:N,2));
r3 = double(r(1:N,3));
...
save("results/thetas_pem_u1u3_armax_N_50.mat","thetas_pem_u1u3_armax")
save("results/H23s_eq_pem_u1u3_armax_N_50.mat","H23s_eq")
